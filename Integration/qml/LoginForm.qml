...
Item {
    ...
    AuthManager {
        ...
        onAuthenticateRequestCompleted: {
            dialog.visible = true
            dialog.text = (error == "Неизвестная ошибка") ? "Выполняется вход" : "Неверный логин или пароль"
        }
    }
    ...
    Button {
        ...
        onClicked: {
            ...
            authManager.authenticate(loginSignIn.text, passwordSignIn.text)
        }
    }
    ...
    BusyIndicator {
        ...
        anchors.horizontalCenter: parent.horizontalCenter
        width: 50; height: 50
        running: authManager.autIsProcessing
        opacity: 0
        OpacityAnimator{
